    ...
    return <>
        <div>
            ...
            <div style={{'--max-width': '1300px'}} className="pt-[clamp(0px,calc((100vw-var(--max-width))/2),100px)]">
                <div className="mx-auto max-w-[var(--max-width)] bg-white border border-b-[3px] border-blue-100 border-b-blue-200 lg:rounded-lg overflow-hidden shadow-[6px_4px_0_var(--tw-shadow-color)] shadow-blue-100 space-y-8 flex items-stretch">
